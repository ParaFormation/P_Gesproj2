...
<nav class="blue">
    <div class="nav-wrapper">
        ...
        <ul class="right hide-on-med-and-down">
            <li><a class="waves-effect waves-light btn light-blue accent-3">Connexion</a></li>
        <li><a class="waves-effect waves-light btn grey lighten-1">Inscription</a></li>
        </ul>
        <ul class="side-nav" id="mobile-demo">
            ...
            <li><a class="waves-effect waves-light">Inscription</a></li>
        </ul>
    </div>
</nav>